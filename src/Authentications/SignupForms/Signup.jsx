  ...
  return (
    <div className='space-y-10'>
        ...
        <form action="" className='grid grid-cols-1 space-y-3 w-[20rem]'>
            <input className='border-b border-green-600 outline-transparent px-2 py-1.5' type="email" name="" id="" placeholder='Enter your email' {...register("phone", { required: true })} />
            <input className='border-b border-green-600 outline-transparent px-2 py-1.5' type="password" name="" id="" placeholder='Enter your password' {...register("nid", { required: true })} />
