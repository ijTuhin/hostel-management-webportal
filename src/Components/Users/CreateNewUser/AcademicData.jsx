  ...
  return (
    <div className='w-full h-full py-14 px-40 space-y-4 bg-gray-50'>
        <div className='flex justify-between items-center border-b border-slate-200 py-3.5'>
            <div>
                <p className='text-xl font-semibold font-serif text-gray-600'>Student Information</p>
        ...
        <div className='flex justify-between items-center border-b border-slate-200 py-3.5'>
            <p className='text-xl font-semibold font-serif text-gray-600'>Department</p>
            <input className='border-2 border-slate-300 outline-teal-500 bg-white px-2 py-1.5 w-80 rounded' type="text" name="" id="" />
        </div>
        <div className='flex justify-between items-center border-b border-slate-200 py-3.5'>
            <div>
                <p className='text-xl font-semibold font-serif text-gray-600'>Academic Session</p>
                <p className='text-sm text-gray-400'>(Current session and the session to complete the program)</p>
            </div>
            <div className='flex flex-col gap-y-3'>
                <input className='border-2 border-slate-300 outline-teal-500 bg-white px-2 py-1.5 w-80 rounded' type="text" name="" id="" />
                <input className='border-2 border-slate-300 outline-teal-500 bg-white px-2 py-1.5 w-80 rounded' type="text" name="" id="" />
