      ...
      <div className="grid grid-cols-2 border-b border-slate-200 py-3.5">
        ...
        <div className="flex flex-col gap-y-3">
          ...
          <div className="flex gap-x-6">
            <p>
              Matric ID:{" "}
              <span className="text-sm text-gray-600 px-2">C183275</span>
            </p>
            <p>
              Section: <span className="text-sm text-gray-600 px-2">BF</span>
            </p>
          </div>
          <p>
            Program:{" "}
          ...
          <div className="flex gap-x-6">
            <p>
              Current session:{" "}
              <span className="text-sm text-gray-600 px-2">Autumn'22</span>
            </p>
            <p>
              Last session:{" "}
              <span className="text-sm text-gray-600 px-2">Spring'25</span>
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-y-3">
          <div className="flex flex-col gap-y-3">
            <p>
              Address:{" "}
              <span className="text-sm text-gray-600 px-2">
                K.B Aman Ali road, Rahattarpul, Chawkbazar.
              </span>
            </p>
            <div className="flex gap-x-6">
              <p>
              ...
              <p>
                District:{" "}
                <span className="text-sm text-gray-600 px-2">Chattogram</span>
              </p>
            </div>
            <p>
              Phone number:{" "}
              <span className="text-sm text-gray-600 px-2">+8801398445357</span>
            </p>
          </div>
        </div>
      </div>
